...

{
  ...
  TJSONDocumentThreadSafe = class(TInterfacedObject,
    IJSONDocument, IJSONEnumerable)
  private
...
begin
  ...
  di:=0;
  SetLength(d,8);
  d[di]:=TJSONDocumentThreadSafe.Create as IJSONDocument;
  while i<l do
   begin
    //key
    key:=VarToStr(x[i]);
